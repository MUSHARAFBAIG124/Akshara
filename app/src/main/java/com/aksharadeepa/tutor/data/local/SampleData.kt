...
object SampleData {
    ...
    val questions = listOf(
        ...
        q(101, 6, "A displacement reaction occurs when:", "One element replaces another", "Only water evaporates", "Light bends", "Salt dissolves only", 0),
        q(101, 7, "A double displacement reaction exchanges:", "Ions between compounds", "Heat only", "Mass with energy", "Magnetic poles", 0),
        ...
        q(102, 6, "Bile helps in digestion of:", "Fats", "Proteins only", "Minerals", "Oxygen", 0),
        q(102, 7, "Xylem mainly transports:", "Water", "Food", "Hormones only", "Carbon dioxide", 0),
        ...
        q(103, 6, "Baking soda is commonly used as:", "Antacid", "Fuel", "Glass fibre", "Wire coating", 0),
        q(103, 7, "Bases usually feel:", "Soapy", "Sandy", "Oily only", "Metallic", 0),
        ...
        q(104, 6, "Resistance is measured in:", "Ohm", "Volt", "Ampere", "Metre", 0),
        q(104, 7, "A good conductor allows:", "Easy current flow", "No charge movement", "Only sound waves", "Only heat loss", 0),
        ...
        q(105, 6, "The brain and spinal cord form the:", "Central nervous system", "Digestive system", "Circulatory system", "Skeletal system", 0),
        q(105, 7, "Adrenaline prepares the body for:", "Emergency response", "Photosynthesis", "Digestion only", "Bone growth", 0),
        ...
        q(201, 6, "The decimal expansion of a rational number is:", "Terminating or recurring", "Always non-recurring", "Always infinite only", "Never possible", 0),
        q(201, 7, "Prime factorisation writes a number as product of:", "Prime factors", "Only fractions", "Only variables", "Only roots", 0),
        ...
        q(202, 6, "A constant polynomial has degree:", "0", "1", "2", "10", 0),
        q(202, 7, "If x = 2 is a zero of p(x), then p(2) equals:", "0", "1", "2", "4", 0),
        ...
        q(203, 6, "Graphically, solutions are shown by:", "Intersection points", "Only shaded circles", "Only bar graphs", "Prime factors", 0),
        q(203, 7, "Elimination method removes:", "One variable", "Both equations", "All constants", "The graph axes", 0),
        ...
        q(204, 6, "A quadratic equation can have at most:", "Two roots", "One term", "Four variables", "No coefficients", 0),
        q(204, 7, "In ax^2 + bx + c = 0, a must not be:", "0", "1", "2", "-1", 0),
        ...
        q(205, 6, "The sequence 4, 8, 12, 16 has common difference:", "4", "8", "12", "16", 0),
        q(205, 7, "An AP is identified by a constant:", "Difference", "Ratio", "Area", "Angle", 0),
        ...
        q(301, 6, "The East India Company began as a:", "Trading company", "School board", "Village council", "Temple trust", 0),
        q(301, 7, "European forts were often built near:", "Trading centres", "Deserts only", "Mountain caves", "Forests only", 0),
        ...
        q(302, 6, "The Battle of Buxar strengthened British control over:", "Bengal region", "Only Goa", "Only Mysuru", "Only Punjab", 0),
        q(302, 7, "Annexation means:", "Taking control of territory", "Building schools only", "Printing books", "Collecting rainfall", 0),
        ...
        q(303, 6, "British revenue policies mainly affected:", "Farmers", "Astronauts", "Ocean sailors only", "Foreign tourists", 0),
        q(303, 7, "Modern communication under British rule included:", "Postal and telegraph systems", "Satellites", "Internet", "Mobile apps", 0),
        ...
        q(304, 6, "The revolt of 1857 involved many:", "Sepoys", "Astronomers", "Factory robots", "Foreign tourists", 0),
        q(304, 7, "Local uprisings were often caused by:", "Oppressive policies", "Better rainfall", "Sports events", "New festivals only", 0),
        ...
        q(305, 6, "Reform movements promoted:", "Education and equality", "Child marriage", "Untouchability", "Foreign rule", 0),
        q(305, 7, "Sir Syed Ahmed Khan worked for:", "Modern education", "Tax collection only", "Military annexation", "Sea trade only", 0)
    )
